      ...
      <Slide v-for="slide in 2" :key="slide">
        <div class="carousel__item w-full">
            ...
            <div v-else class="min-h-screen bg-home-second bg-cover bg-center">
                <div class="bg-gradient-to-b from-[#00000081] to-[#00000081] h-screen flex flex-col lg:flex-row gap-10 justify-center lg:justify-between items-center px-8 lg:px-36">
