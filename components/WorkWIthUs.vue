<template>
    <div id="TrabalheConosco" class="py-20 px-4 lg:px-28">
        <p class="text-2xl lg:text-3xl font-black text-center my-5">Trabalhe com a gente</p>
                ...
                <label for="dropzone-file"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Clique para
                                carregar</span> ou arrastar e soltar
                        </p>
